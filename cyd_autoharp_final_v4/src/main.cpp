...
void drawVolumeSlider() {
  int y = 160; // Start higher (was 180)
  int h = 40;  // Taller (was 20)
  int w = SCREEN_WIDTH;
...
void handleEditorTouch(int tx, int ty) {
  ...
  if (ty < topH) {
    ...
    case 1:   // LFO Tgt
    {
      ...
      v++;
      if (v > 8) // Cycle 0..8 (TARGET_LFO_DEPTH is 7, new target is 8)
        v = 0;
      activeParams.lfoTarget = (LfoTarget)v;
      drawSliderControl(rx, ry, rw, rh, "LFO Tgt", (float)v, 0, 8, true);
      lastTopPress = millis();
    } break;
    case 2: // LFO Type
    {
    ...
    case 3: // LDR Tgt
    {
      ...
      drawSliderControl(rx, ry, rw, rh, "LDR Tgt", (float)v, 0, 8, true);
      lastTopPress = millis();
    } break;
    }
