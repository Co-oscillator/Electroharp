...
void drawVolumeSlider() {
  ...
  // Optional: Add Label? User didn't ask but "Volume" text might be nice?
  // User spec: "visually match the colored bar sliders used in the editor"
  // Editor sliders usually have text inside.
  // I'll stick to just the bar for now as per "visually match".
}
