...
> **[i] Troubleshooting Tip:** If touch inputs seem misaligned or unresponsive (preventing you from selecting options), **Press and Hold** anywhere on this Boot Screen for **3 seconds**. This will force the device into **Touch Calibration Mode**.
