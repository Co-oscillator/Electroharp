...
#define STRING_HEIGHT 240 // Top 3/4 roughly
#define BUTTON_HEIGHT 80  // Bottom section
...
#define CONFIG_VERSION 0xCAFEBABE

// --- Config Enums & Structs ---
...
extern ArpMode arpMode; // Global Arp Mode
